...
export default class EmojiSlider extends Component {
        ...
        <View style={{ height: 350, marginTop: 30 }}>
          ...
          <View>
            <Image
              ...
              source={require("example/emojiAssets/emo7.png")}
            />
          </View>
        </View>
      );
  ...
  renderImageContent = () => {
    const images = [
      { id: 0, source: require("example/emojiAssets/emo1.png") },
      { id: 1, source: require("example/emojiAssets/emo2.png") },
      { id: 2, source: require("example/emojiAssets/emo3.png") },
      { id: 3, source: require("example/emojiAssets/emo4.png") },
      { id: 4, source: require("example/emojiAssets/emo5.png") },
      { id: 5, source: require("example/emojiAssets/emo6.png") },
    ];
