...
export default class EmojiSlider extends Component {
        ...
        <View style={{ height: 350, marginTop: 30 }}>
          ...
          <View>
            <Image
              ...
              source={require("assets/emojiImage/emo7.png")}
            />
          </View>
        </View>
      );
  ...
  renderImageContent = () => {
    const images = [
      { id: 0, source: require("assets/emojiImage/emo1.png") },
      { id: 1, source: require("assets/emojiImage/emo2.png") },
      { id: 2, source: require("assets/emojiImage/emo3.png") },
      { id: 3, source: require("assets/emojiImage/emo4.png") },
      { id: 4, source: require("assets/emojiImage/emo5.png") },
      { id: 5, source: require("assets/emojiImage/emo6.png") },
    ];
