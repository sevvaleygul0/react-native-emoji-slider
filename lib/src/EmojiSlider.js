...
const images = [
  {id: 0, source: require('../emojiImage/emo1.png')},
  {id: 1, source: require('../emojiImage/emo2.png')},
  {id: 2, source: require('../emojiImage/emo3.png')},
  {id: 3, source: require('../emojiImage/emo4.png')},
  {id: 4, source: require('../emojiImage/emo5.png')},
  {id: 5, source: require('../emojiImage/emo6.png')},
];

export default class EmojiSlider extends Component {
  constructor(props) {
    super(props);
    const {emojiStyles} = props;
    this.state = {
      value: 0.45,
      mood: null,
  ...
  selectedImage = item => {
    ...
    if (item.id === selectedImage) {
        ...
        <View style={{height: 350, marginTop: 30}}>
          ...
          <View>
            <Image
              ...
              source={require('../emojiImage/emo7.png')}
            />
          </View>
        </View>
      );
      ...
      return (
        <View>
          <Image
            style={[{width: 25, height: 35, marginTop: 50}]}
            source={item.source}
          />
        </View>
      );
